  ...
  actions: {
    ...
    async getShortAnswers() {
      try {
        ...
        let postCount = responseHeaders['x-wp-total'];
        let pagesCount = responseHeaders['x-wp-totalpages'];
        console.log('evaluationStore -  response headers postCount', postCount);
        console.log(
          'evaluationStore -  response headers pagesCount',
          pagesCount
        );
